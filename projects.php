...
<head>
  ...
  <meta charset="UTF-8">
  <title>Portfolio | Gabrielle Taylor</title>
...
<div class="row">
  <div class="col-sm-5 col-sm-offset-1 well well-lg">
    <h2 style="color: black; font-size: 18px; font-family: Arial Black; border-bottom: 4px #4aaaa5 solid; padding-bottom: 10px;">Portfolio</h2>
